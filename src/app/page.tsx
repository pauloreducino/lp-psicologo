...
export const metadata: Metadata = {
  title: "Rafael Mendes — Psicólogo Clínico em São Paulo",
  description:
  ...
  openGraph: {
    title: "Rafael Mendes — Psicólogo Clínico",
    description:
      "Cuidado com a sua saúde mental começa aqui. Atendimento presencial e online.",
